<x-app-layout>
    ...
    <div class="py-8 max-w-xl mx-auto px-4">
        <form method="POST"
            ...
            <button type="button" class="chip-emotion px-4 py-2 rounded border border-gray-300 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-black @if(old('emotion', $transaction->emotion) == $key) border-black shadow-lg text-black @endif" data-value="{{ $key }}">
                      {{ $label }}
                    </button>
                  @endforeach
                </div>
